...
void main() {
  ...
  test('List Restaurant Success', () async {
    ...
    ListProvider providerList =
        ListProvider(apiService: ApiService(client));
    await providerList.fetchListRestaurant();
    ...
    var cityTest = providerList.result?.restaurants[1].city ==
        Restaurant.fromJson(listRestaurantTest).city;
  ...
  test('List Restaurant Error', () async {
    ...
    var pictureIdTest = providerList.result?.restaurants[0].pictureId ==
        Restaurant.fromJson(listRestaurantTest).pictureId;
    var ratingTest = providerList.result?.restaurants[0].rating ==
        Restaurant.fromJson(listRestaurantTest).rating;
